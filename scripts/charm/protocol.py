...
KIND_BOOT = _c("NDJSON_KIND_BOOT")
KIND_STAT = _c("NDJSON_KIND_STAT")
KIND_QUIESCE = _c("NDJSON_KIND_QUIESCE")
KIND_FINDING = _c("NDJSON_KIND_FINDING")
KIND_MESSAGE = _c("NDJSON_KIND_MESSAGE")
